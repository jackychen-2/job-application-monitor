...
class OpenAIProvider:
    ...
    _SYSTEM_PROMPT = (
        ...
        "\n\n"
        "IMPORTANT: is_job_application=true for any trackable, role-specific hiring thread, including: "
        "application confirmations, acknowledgments, status updates, OA/assessment invites, interview invites, "
        "offer/rejection updates, post-offer onboarding communication, and recruiter or TA outreach about a specific role. "
        "\n"
        ...
        "  * 'job_application'     — a trackable role-specific hiring thread, including recruiter reach-out, "
        "application confirmation, status update, OA/assessment invite, interview invite, offer, rejection, "
        "or onboarding/background-check communication\n"
        ...
        "  recruiter outreach about a specific role should use email_category='job_application' and "
        ...
        "  * Do NOT use assessment/test/challenge/invitation names as the job title.\n"
        "    If the email only mentions HackerRank/CodeSignal/Codility or a technical assessment\n"
        "    but never states the real role, return job_title/base_title/title_with_req_id as empty strings.\n"
        ...
        "  * 'Recruiter Reach-out' - recruiter/TA proactively reached out about a specific role; this is still a trackable job_application thread\n"
